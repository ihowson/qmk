...
[_QWERTY] = {
  ...
  // GAMING WOOH
  {   KC_LCTRL, KC_LCTRL, KC_LALT, _______, KC_SPACE, _______,   MO(_RAISE), _______},
  ...
  { KC_RCTRL,    KC_SPACE,   KC_RGUI,  KC_RALT,  KC_RCTRL,     KC_LEFT,     KC_DOWN,  KC_RIGHT},
},
...
[_RAISE] = {
    ...
    {     _______, _______, DF(_QWERTY),         DF(_GAME), DF(_MOUSE), KC_MS_RIGHT, _______, _______},
    {     _______, _______,     RGB_TOG, RGB_MODE_FORWARD,    RGB_HUI,     RGB_SAI, RGB_VAI, _______},
    {     _______, _______,     _______,          _______,    _______,     _______, _______, _______},
    {     _______, _______,     _______,          _______,    _______,     _______, _______, _______},

    // RIGHT HAND
    { _______, KC_MEDIA_REWIND, KC_MEDIA_PLAY_PAUSE, KC_MEDIA_FAST_FORWARD,   _______,     _______,   _______,  _______},
    ...
    { _______,            FLIP,   SGUI(KC_LBRACKET),     SGUI(KC_RBRACKET),   _______,   KC_PGDOWN,   _______,  _______},
...
[_MOUSE] = {
    ...
    // TODO: need scroll wheel controls

    // RIGHT HAND
    { _______, _______, _______, _______,    _______,     _______,   _______,  _______},
    {   _______,               _______,               _______,              _______,     _______,      _______, _______,  _______},
    {    _______,                KC_MS_WH_UP,                KC_MS_UP,                KC_MS_WH_DOWN,       _______, _______, _______, _______},
    { KC_LEFT,             KC_MS_LEFT,               KC_MS_DOWN,            KC_MS_RIGHT, KC_MS_BTN2,  KC_MS_BTN2,   _______,  _______},
    { _______,                _______,   SGUI(KC_LBRACKET),   SGUI(KC_RBRACKET),   _______,    _______,   _______,  _______},
    { _______,          KC_MS_BTN1,          KC_MS_BTN2,             _______,   _______,      _______,   _______,  _______},
},

// TODO: mouse wheel left right up down
...
[_GAME] = {
  ...
  {    KC_LSFT,  _______,    KC_Z,    KC_X,     KC_C,    KC_V,       KC_B, _______},
//   {   KC_LCTRL, KC_LCTRL, KC_LALT, _______, KC_SPACE, _______, MO(_RAISE), _______},
  {   KC_LCTRL, KC_LCTRL, KC_LALT, _______, KC_SPACE, _______, DF(_QWERTY), _______},
  {    _______,  _______, _______, _______,  _______, _______,    _______, _______},
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    rgblight_set_layer_state(0, layer_state_cmp(state, _RAISE)); // raise
    rgblight_set_layer_state(1, layer_state_cmp(state, _MOUSE)); // mouse
    rgblight_set_layer_state(2, layer_state_cmp(state, _GAME)); // game
    return state;
}
#endif
